...
addEvent(window, "load", function(e)
{
	addEvent(document, "click", function(e)
	{
	   ...
	   {	
			...
			{
				var today = new Date();
				var expires = 360000*2*1;//var expires = 3600000*24*1 = 1 ngày b?n (expires=1000 týõng ?ng v?i 1 giây);
      ...
      //}
	    // -------------- end pop 2 --------------------
		//B?n có th? copy code trong kho?ng "---pop---" và "--- end Pop---" t?o ra nhi?u kh?i ð? m? cùng lúc nhi?u trang khác nhau, và t?t nhiên
		//b?n c?ng có th? tùy ch?nh th?i gian cho chúng
	});
});